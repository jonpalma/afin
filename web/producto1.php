    ...
    <div class="jumbotron bg-orange">
        <div class="container coberturas">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Edades de aceptación</td>
                                <td class="text-uppercase text-center">18 a 70 años</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-sm-4">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Edades de aceptación</td>
                                <td class="text-uppercase text-center">18 a 59 años</td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="clearfix"></div>
                ...
                <div class="clearfix"></div>
                <p><small>Plazo de contratación: 10 años</small><br />
                <small>*Aplican restricciones de acuerdo a la edad del asegurado</small></p>
            </div>
        </div>
    </div>
<!-- END COBERTURAS -->
